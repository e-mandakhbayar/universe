...
echo "$($PSQL "SELECT distinct(name) from games join teams on teams.team_id = games.winner_id or teams.team_id = games.opponent_id where year = 2014 and round = 'Eighth-Final'")"
